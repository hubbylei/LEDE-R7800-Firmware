...
git clone https://github.com/xiaorouji/openwrt-passwall -b luci package/custom/luci-app-passwall
git clone https://github.com/xiaorouji/openwrt-passwall -b packages package/custom/openwrt-passwall
git clone https://github.com/tty228/luci-app-wechatpush package/custom/luci-app-wechatpush
